...
update `service_urls` set baseurl='https://staging.api.247-inc.net', headers='{\"apikey\": \"8UjizUNm8jcN4lZgsReIgUGXeqbctjYT\"}' where id=6;
update `service_urls` set baseurl='https://central.247-inc.net/adminconsole/rest/domainwhitelist/live' where id=7;
update `service_urls` set baseurl='https://${clientId}.portal.assist.staging.247-inc.net' where id=8;
