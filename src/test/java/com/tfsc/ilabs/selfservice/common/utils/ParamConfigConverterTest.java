...
public class ParamConfigConverterTest {

    @InjectMocks
    ParamConfigConverter converter;

    @Mock
    ParamConfigTemplate requestDefinition;
    ...
    public void test_convertToEntityAttribute(){
        ...
        ParamConfigTemplate result = converter.convertToEntityAttribute(json);
        Assert.assertNull(result);
    }
